...
button_register = KeyboardButton(text="Зарегистрироваться")
...
async def finances(message: Message, state: FSMContext):
    ...
    await message.reply("Введите категорию расходов 1:")
...
async def expenses1(message: Message, state: FSMContext):
    ...
    await message.reply("Введите категорию расходов 2:")
...
async def expenses2(message: Message, state: FSMContext):
    ...
    await message.reply("Введите категорию расходов 3:")
...
async def expenses3(message: Message, state: FSMContext):
    ...
    cursor.execute('''
        UPDATE users
        SET category1 = ?, category2 = ?, category3 = ?, expenses1 = ?, expenses2 = ?, expenses3 = ?
        WHERE telegram_id = ?
